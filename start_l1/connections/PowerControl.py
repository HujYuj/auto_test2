...
class TCPIPVisaControlMode(ControlMode):
    ...
    def power_init(self, address: str):
        self.PS_handler = self.resourceManager.open_resource("TCPIP0::%s::INSTR"%(address))
...
class TCPIPVisaRawSocketControlMode(ControlMode):
    ...
    def power_init(self, address: str):
        self.PS_handler = self.resourceManager.open_resource("TCPIP0::%s::8462::SOCKET" % address)
...
if __name__ == "__main__":
    ...
    power_control.power_init(address="15")
